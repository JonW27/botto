...
class Plugin0 extends Discord{//can also extend discord and messenger
    ...
    //When making methods, you might want to add a  at the start of the name to avoid overridding certain methods.
